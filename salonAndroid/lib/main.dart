...
import 'package:salon/widgets/splashscreen.dart';
      ...
      child: Consumer<ApiCalls>(
        builder: (ctx, auth, _) => MaterialApp(
          ...
          routes: {
            ...
            BusinessSignUpFlow8.routeName: (ctx) => const BusinessSignUpFlow8(),
            BusinessSignUpFlow9.routeName: (ctx) => const BusinessSignUpFlow9(),
            ...
            SelectPreferenceScreen.routeName: (ctx) => SelectPreferenceScreen(),
            MyFavorites.routeName: (ctx) => MyFavorites(),
            ExploreShopList.routeName: (ctx) => ExploreShopList(),
            DefaultCustomerProfileScreen.routeName: (ctx) =>
                DefaultCustomerProfileScreen(),
            CustomerCutDetails.routeName: (ctx) => CustomerCutDetails(),
            MapScreen.routeName: (ctx) => MapScreen(),
            PersonalInformation.routeName: (ctx) => PersonalInformation(),
            DemoScreen.routeName: (ctx) => DemoScreen(),
            DemoProfileScreen.routeName: (ctx) => DemoProfileScreen(),
            DemoCutDetails.routeName: (ctx) => DemoCutDetails(),
            ShopDetailsPage.routeName: (ctx) => ShopDetailsPage(),
            HairCutBookingDetailsPage.routeName: (ctx) =>
                HairCutBookingDetailsPage(),
          },
        ),
      ),
    );
